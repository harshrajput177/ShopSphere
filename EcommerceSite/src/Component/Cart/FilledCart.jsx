...
const CartDrawer = ({ onClose }) => {
  ...
  const bagTotal = cartItems.reduce(
    (acc, item) => acc + (item.originalPrice || item.price) * item.qty, 0
  );

  const totalDiscount = cartItems.reduce(
    (acc, item) => acc + ((item.originalPrice || item.price) - item.price) * item.qty, 0
  );
  ...
  // ✅ Loading
  if (loading) return (
    <div className="Filled-cart-overlay">
            ...
            <>
              ...
              <div className="Filled-cart-price">
                ...
                <p className="discount">
                  ...
                  <span className="discount-old-price">₹{bagTotal}</span>
                </p>
              </div>
              ...
              <div className="cart-trust">
                <div className="trust-item">
                  <FaCheckCircle className="icon-footer-cart" />
                  <span>Genuine <br />products</span>
                </div>
                <div className="trust-item">
                  <FaShieldAlt className="icon-footer-cart" />
                  <span>Secure <br />payments</span>
                </div>
                <div className="trust-item">
                  <FaUndo className="icon-footer-cart" />
